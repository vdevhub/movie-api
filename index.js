...
let allowedOrigins = ['http://localhost:8080', 'http://localhost:1234', 'http://localhost:4200', 'https://myflix-vdevhub.netlify.app', 'https://vdevhub.github.io', 'https://github.com'];
app.use(cors());
// app.use(cors({
